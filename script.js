...
async function stream() {
    ...
    statusEl.textContent = "Looking for video parts...";

    try {
        const last = await findLastPart(videoId, "4500");
        ...
        statusEl.textContent = "Streaming failed. Please check your CORS settings and try again.";
    }
}
